...
def llm_factor_patch():
    single = AKShareDataSingleton()
    single.classified_functions["数据工具"].append("llm_factory.class_instantiation: 使用llm_factor通过分析股票相关新闻、历史价格数据,以及相关公司或指数的信息来预测股票的未来走势，这个方法预测趋势并给出理由，不预测数值")
...
- news (List[Dict[str, Any]]): 新闻列表,每条新闻包含 'date' 和 'headline' 键
...
news = [
    {"date": "2023-06-25", "headline": "阿里巴巴集团今日宣布，将投资10亿元人民币用于改善其物流网络。"},
    {"date": "2023-06-26", "headline": "阿里巴巴第一季度财报显示，营收同比增长9%，超出市场预期。"},
    # ... 更多新闻
]
