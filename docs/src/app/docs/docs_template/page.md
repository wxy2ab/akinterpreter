...
这个协议的大概意思就是，这只是一个个人许可。这不是一份具有"再发行"条款的协议。因此，当你再发行akinterpreter的时候。你应该排除文档的源代码。或者你可以自己找Tailwind Labs Inc.获得一份许可。The gist of this License is that it's a personal license only. It doesn't include a "redistribution" clause. So, when you redistribute akinterpreter, you should exclude the documentation's source code. Alternatively, you can seek a license directly from Tailwind Labs Inc.
---
